...
if(isset($_SESSION['id'])&&isset($_SESSION['role'])&&$_SESSION['role']=='admin'){
    $users = new User() ;
    $user =$users->all()->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar bg-dark text-white">
                <div class="sidebar-sticky">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../view/customer.php"><i class="fas fa-users me-2"></i>Customers</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <?php if(isset($user)&&!empty($user)){ 
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $items['email']?></td>
                                        <td><?= $items['role']?></td>
                                        <td><?= (new DateTime($items['created_at']))->format('d F Y')?></td>
                                    </tr>
                            <?php } } ?>
                        </tbody>
                    </table>
